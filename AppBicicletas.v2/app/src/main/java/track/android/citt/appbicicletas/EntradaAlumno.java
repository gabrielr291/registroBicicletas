...
public class EntradaAlumno extends AppCompatActivity {
        ...
        public void onClick(View view) {
            switch (view.getId()){
                case R.id.btnEscaner:
                    new IntentIntegrator(EntradaAlumno.this).initiateScan();
                    break;
                case R.id.btnBuscar:
                ...
                case R.id.btnGuardar:
                    ...
                    Evento eve = new Evento(objSDF.format(objDate),"");

                    databaseReference.child("alumno").child(rutAlumno).child("evento").setValue(eve);
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(EntradaAlumno.this, PreEntradaActivity.class));
    }
}
